...
const options = {
	method: 'POST',
	headers: {
		'x-rapidapi-key': 'ce281d5357msh7ab3994cc8469b2p109b50jsn556ba1f4c9be',
...
let graphData = []; //empty array, where the fetched data will be stored in

fetch(url, options)
.then(res => res.json())
.then(data => {
	console.log(data.location, data.created)
